...
" Global settings
source ~/.config/nvim/plugs/global-vars.vim
source ~/.config/nvim/plugs/settings.vim
source ~/.config/nvim/plugs/auto-commands.vim
source ~/.config/nvim/plugs/mappings.vim
source ~/.config/nvim/plugs/togglers.vim
...
source ~/.config/nvim/plugs/nerd-commenter.vim
source ~/.config/nvim/plugs/open-url.vim
source ~/.config/nvim/plugs/rainbow.vim
source ~/.config/nvim/plugs/rest-console.vim
source ~/.config/nvim/plugs/rooter.vim
...
source ~/.config/nvim/plugs/vimwiki.vim
